          ...
          <div className="md:hidden pb-8 pt-2">
            <div className="flex flex-col gap-5">
              ...
              <div className={`flex items-center gap-5 pt-3 border-t ${isTransparent ? "border-white/20" : "border-charcoal/10"}`}>
                ...
                <a href="mailto:info@boomerangpilatesnc.com" className={isTransparent ? "text-white/60 hover:text-white" : "text-charcoal/40 hover:text-charcoal"} aria-label="Email">
