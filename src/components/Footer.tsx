    ...
    <footer className="bg-charcoal text-cream/80">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold tracking-wide uppercase text-cream mb-4">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-cream/60">
              ...
              <p>
                <a href="tel:+15125551234" className="hover:text-cream transition-colors">
                  (512) 555-1234
                </a>
              </p>
            </div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="#" aria-label="Facebook" className="text-cream/40 hover:text-cream transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-cream/10 mt-12 pt-8 text-center">
          <p className="text-xs text-cream/40">
            &copy; {new Date().getFullYear()} Boomerang Pilates. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
