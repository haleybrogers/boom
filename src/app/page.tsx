...
import OpeningWeekPromoPopup from "@/components/OpeningWeekPromoPopup";
    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-warm-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          {/* Demo nudge for the apparatus is rendered inside
              OfferingCards directly under the Apparatus offering, so
              it sits next to the offering it's selling — see
              components/OfferingCards.tsx. */}
          <OfferingCards />
        </div>
      </section>
